...
import info.android.voicerecorder.database.RecordingItem
import info.android.voicerecorder.player.PlayerFragment
import info.android.voicerecorder.removeDialog.RemoveDialogFragment
import java.io.File
...
class ListRecordAdapter: RecyclerView.Adapter<ListRecordAdapter.ViewHolder> () {
    ...
    class ViewHolder private constructor(itemView: View) : RecyclerView.ViewHolder(itemView){
        var vName: TextView = this.itemView.findViewById(R.id.file_name_text)
        var vLength: TextView = this.itemView.findViewById(R.id.file_length_text)
        var cardView: View = this.itemView.findViewById(R.id.card_view)
